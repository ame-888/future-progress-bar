  ...
  },
  {
    ...
    measurements: [
      ...
      },
      {
        ...
        unit: "countries",
        levels: [
          { level: 1, goal: 3, aiPredictions: [{ name: "Grok 4.20", year: 2027 }, { name: "Claude 4.6 Sonnet", year: 2027 }] },
          { level: 2, goal: 10, aiPredictions: [{ name: "Grok 4.20", year: 2030 }, { name: "Claude 4.6 Sonnet", year: 2031 }] },
          { level: 3, goal: 30, aiPredictions: [{ name: "Grok 4.20", year: 2035 }, { name: "Claude 4.6 Sonnet", year: 2037 }] },
          { level: 4, goal: 75, aiPredictions: [{ name: "Grok 4.20", year: 2040 }, { name: "Claude 4.6 Sonnet", year: 2044 }] },
          { level: 5, goal: 120, aiPredictions: [{ name: "Grok 4.20", year: 2045 }, { name: "Claude 4.6 Sonnet", year: 2051 }] },
          { level: 6, goal: 170, aiPredictions: [{ name: "Grok 4.20", year: 2052 }, { name: "Claude 4.6 Sonnet", year: 2060 }] },
          { level: 7, goal: 195, aiPredictions: [{ name: "Grok 4.20", year: 2060 }, { name: "Claude 4.6 Sonnet", year: 2072 }] },
        ],
        history: [{ value: 1 }],
      },
      {
        ...
        unit: "countries",
        levels: [
          { level: 1, goal: 1, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2029 }, { name: "Grok 4.20", year: 2032 }] },
          { level: 2, goal: 5, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2034 }, { name: "Grok 4.20", year: 2035 }] },
          { level: 3, goal: 15, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2040 }, { name: "Grok 4.20", year: 2038 }] },
          { level: 4, goal: 40, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2047 }, { name: "Grok 4.20", year: 2042 }] },
          { level: 5, goal: 80, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2055 }, { name: "Grok 4.20", year: 2047 }] },
          { level: 6, goal: 140, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2065 }, { name: "Grok 4.20", year: 2053 }] },
          { level: 7, goal: 195, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2085 }, { name: "Grok 4.20", year: 2065 }] },
        ],
        history: [{ value: 0 }],
      },
    ]

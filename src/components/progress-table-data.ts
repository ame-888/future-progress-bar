    ...
    measurements: [
      {
        ...
        unit: "people",
        levels: [
          { level: 1, goal: 500, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2027 }] },
          { level: 2, goal: 10000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2030 }] },
          { level: 3, goal: 100000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2034 }] },
          { level: 4, goal: 1000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2038 }] },
          { level: 5, goal: 10000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2043 }] },
          { level: 6, goal: 100000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2050 }] },
          { level: 7, goal: 1000000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2058 }] },
        ],
        history: [{ value: 85 }],
      },
      {

          ...
          measurements: [
            {
              ...
              unit: "countries",
              levels: [
                { level: 1, goal: 1, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2061 }, { name: "Grok 4.20", year: 2065 }, { name: "GPT-5.4 Thinking Mini", year: 2085 }] },
                { level: 2, goal: 5, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2069 }, { name: "Grok 4.20", year: 2075 }, { name: "GPT-5.4 Thinking Mini", year: 2095 }] },
                { level: 3, goal: 15, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2078 }, { name: "Grok 4.20", year: 2085 }, { name: "GPT-5.4 Thinking Mini", year: 2105 }] },
                { level: 4, goal: 30, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2086 }, { name: "Grok 4.20", year: 2095 }, { name: "GPT-5.4 Thinking Mini", year: 2120 }] },
                { level: 5, goal: 75, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2097 }, { name: "Grok 4.20", year: 2110 }, { name: "GPT-5.4 Thinking Mini", year: 2150 }] },
                { level: 6, goal: 130, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2109 }, { name: "Grok 4.20", year: 2135 }, { name: "GPT-5.4 Thinking Mini", year: 2190 }] },

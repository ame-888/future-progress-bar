  ...
  },
  {
    ...
    measurements: [
      ...
      },
      {
        ...
        unit: "people",
        levels: [
          { level: 1, goal: 300, aiPredictions: [{ name: "GPT-5.4 Thinking Mini", year: 2031 }, { name: "Gemini 3.1 Pro Preview", year: 2032 }, { name: "Claude 4.6 Sonnet", year: 2050 }] },
          { level: 2, goal: 3000, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2055 }, { name: "GPT-5.4 Thinking Mini", year: 2064 }, { name: "Claude 4.6 Sonnet", year: 2075 }] },
          { level: 3, goal: 30000, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2080 }, { name: "GPT-5.4 Thinking Mini", year: 2097 }, { name: "Claude 4.6 Sonnet", year: 2110 }] },
          { level: 4, goal: 300000, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2105 }, { name: "GPT-5.4 Thinking Mini", year: 2130 }, { name: "Claude 4.6 Sonnet", year: 2160 }] },
          { level: 5, goal: 3000000, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2122 }, { name: "GPT-5.4 Thinking Mini", year: 2163 }, { name: "Claude 4.6 Sonnet", year: 2230 }] },
          { level: 6, goal: 30000000, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2140 }, { name: "GPT-5.4 Thinking Mini", year: 2197 }, { name: "Claude 4.6 Sonnet", year: 2320 }] },
          { level: 7, goal: 300000000, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2165 }, { name: "GPT-5.4 Thinking Mini", year: 2230 }, { name: "Claude 4.6 Sonnet", year: 2500 }] },
        ],
        history: [
          { value: 217 }
        ],
  ...
  },
  {
    ...
    measurements: [
      ...
      },
      {
        ...
        unit: "hours",
        levels: [
          { level: 1, goal: 1, label: "1 Hour", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2033 }] },
          { level: 2, goal: 24, label: "24 Hours", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2037 }] },
          { level: 3, goal: 168, label: "1 Week", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2042 }] },
          { level: 4, goal: 730, label: "1 Month", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2047 }] },
          { level: 5, goal: 8760, label: "1 Year", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2055 }] },
          { level: 6, goal: 43800, label: "5 Years", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2067 }] },
          { level: 7, goal: 438000, label: "50 Years", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2110 }] },
        ],
        history: [{ value: 0 }],
      },
      {
    ...
    measurements: [
      {
        ...
        unit: "qubits",
        levels: [
          { level: 1, goal: 10000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2027 }] },
          { level: 2, goal: 50000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2029 }] },
          { level: 3, goal: 100000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2031 }] },
          { level: 4, goal: 500000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2033 }] },
          { level: 5, goal: 1000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2035 }] },
          { level: 6, goal: 10000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2039 }] },
          { level: 7, goal: 1000000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2047 }] },
        ],
        history: [
          {
            value: 6100,

          ...
          measurements: [
            {
              ...
              unit: "users",
              levels: [
                { level: 1, goal: 15000000, label: "15M", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2028 }, { name: "Grok 4.20", year: 2029 }] },
                { level: 2, goal: 30000000, label: "30M", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2030 }, { name: "Grok 4.20", year: 2032 }] },
                { level: 3, goal: 60000000, label: "60M", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2033 }, { name: "Grok 4.20", year: 2035 }] },
                { level: 4, goal: 100000000, label: "100M", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2036 }, { name: "Grok 4.20", year: 2039 }] },
                { level: 5, goal: 200000000, label: "200M", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2039 }, { name: "Grok 4.20", year: 2043 }] },
                { level: 6, goal: 500000000, label: "500M", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2044 }, { name: "Grok 4.20", year: 2050 }] },
                { level: 7, goal: 1000000000, label: "1B", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2050 }, { name: "Grok 4.20", year: 2060 }] },
              ],
            ...
            },
            {
              ...
              unit: "hours",
              levels: [
                { level: 1, goal: 72, label: "3 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2027 }] },
                { level: 2, goal: 168, label: "7 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2029 }] },
                { level: 3, goal: 360, label: "15 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2031 }] },
                { level: 4, goal: 720, label: "30 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2033 }] },
                { level: 5, goal: 2160, label: "90 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2037 }] },
                { level: 6, goal: 4320, label: "180 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2040 }] },

        ...
        },
{
          ...
          measurements: [
            ...
            },
            {
              ...
              unit: "%",
              levels: [
                { level: 1, goal: 0.001, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2032 }, { name: "Claude 4.6 Sonnet", year: 2033 }, { name: "GPT-5.4 Thinking Mini", year: 2038 }] },
                { level: 2, goal: 0.05, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2038 }, { name: "Claude 4.6 Sonnet", year: 2040 }, { name: "GPT-5.4 Thinking Mini", year: 2048 }] },
                { level: 3, goal: 1, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2047 }, { name: "Claude 4.6 Sonnet", year: 2048 }, { name: "GPT-5.4 Thinking Mini", year: 2065 }] },
                { level: 4, goal: 5, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2055 }, { name: "Claude 4.6 Sonnet", year: 2055 }, { name: "GPT-5.4 Thinking Mini", year: 2082 }] },
                { level: 5, goal: 33, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2065 }, { name: "Gemini 3.1 Pro Preview", year: 2075 }, { name: "GPT-5.4 Thinking Mini", year: 2145 }] },
                { level: 6, goal: 66, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2073 }, { name: "Gemini 3.1 Pro Preview", year: 2090 }, { name: "GPT-5.4 Thinking Mini", year: 2205 }] },
                { level: 7, goal: 99, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2084 }, { name: "Gemini 3.1 Pro Preview", year: 2125 }, { name: "GPT-5.4 Thinking Mini", year: 2300 }] },
              ],
              history: [
                {
                  value: 0,
        ...
        },
{
          ...
          measurements: [
            ...
            },
            {
              ...
              unit: "vehicles",
              levels: [
                { level: 1, goal: 15, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2032 }, { name: "GPT-5.4 Thinking Mini", year: 2032 }, { name: "Claude 4.6 Sonnet", year: 2033 }] },
                { level: 2, goal: 300, aiPredictions: [{ name: "Gemini 3.1 Pro Preview", year: 2035 }, { name: "Claude 4.6 Sonnet", year: 2035 }, { name: "GPT-5.4 Thinking Mini", year: 2036 }] },
                { level: 3, goal: 6000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2037 }, { name: "Gemini 3.1 Pro Preview", year: 2038 }, { name: "GPT-5.4 Thinking Mini", year: 2041 }] },
                { level: 4, goal: 120000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2040 }, { name: "Gemini 3.1 Pro Preview", year: 2041 }, { name: "GPT-5.4 Thinking Mini", year: 2047 }] },
                { level: 5, goal: 2400000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2043 }, { name: "Gemini 3.1 Pro Preview", year: 2045 }, { name: "GPT-5.4 Thinking Mini", year: 2054 }] },
                { level: 6, goal: 48000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2048 }, { name: "Gemini 3.1 Pro Preview", year: 2050 }, { name: "GPT-5.4 Thinking Mini", year: 2063 }] },
                { level: 7, goal: 960000000, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2057 }, { name: "Gemini 3.1 Pro Preview", year: 2065 }, { name: "GPT-5.4 Thinking Mini", year: 2078 }] },
              ],
              history: [{
                value: 0,
                details: [
        ...
        },
    {
          ...
          measurements: [
            ...
            },
            {
              ...
              unit: "hours",
              levels: [
                { level: 1, goal: 72, label: "3 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2027 }, { name: "GPT-5.4 Thinking Mini", year: 2032 }] },
                { level: 2, goal: 168, label: "7 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2029 }, { name: "GPT-5.4 Thinking Mini", year: 2038 }] },
                { level: 3, goal: 360, label: "15 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2031 }, { name: "GPT-5.4 Thinking Mini", year: 2048 }] },
                { level: 4, goal: 720, label: "30 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2033 }, { name: "GPT-5.4 Thinking Mini", year: 2060 }] },
                { level: 5, goal: 2160, label: "90 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2037 }, { name: "GPT-5.4 Thinking Mini", year: 2082 }] },
                { level: 6, goal: 4320, label: "180 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2040 }, { name: "GPT-5.4 Thinking Mini", year: 2094 }] },
                { level: 7, goal: 8760, label: "365 days", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2045 }, { name: "GPT-5.4 Thinking Mini", year: 2115 }] },
              ],

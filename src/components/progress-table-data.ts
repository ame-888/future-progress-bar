          ...
          measurements: [
            {
              ...
              isLowerBetter: true,
              levels: [
                { level: 1, goal: 100, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2028 }, { name: "GPT-5.4 Thinking Mini", year: 2030 }, { name: "Gemini 3.1 Pro Preview", year: 2031 }] },
                { level: 2, goal: 20, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2035 }, { name: "Gemini 3.1 Pro Preview", year: 2037 }, { name: "GPT-5.4 Thinking Mini", year: 2037 }] },
                { level: 3, goal: 5, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2041 }, { name: "Gemini 3.1 Pro Preview", year: 2044 }, { name: "GPT-5.4 Thinking Mini", year: 2045 }] },
                { level: 4, goal: 1, aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2048 }, { name: "Gemini 3.1 Pro Preview", year: 2051 }, { name: "GPT-5.4 Thinking Mini", year: 2055 }] },
                { level: 5, goal: 0.101325, label: "1000 atm", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2054 }, { name: "Gemini 3.1 Pro Preview", year: 2059 }, { name: "GPT-5.4 Thinking Mini", year: 2064 }] },
                { level: 6, goal: 0.00506625, label: "50 atm", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2061 }, { name: "Gemini 3.1 Pro Preview", year: 2068 }, { name: "GPT-5.4 Thinking Mini", year: 2075 }] },
                { level: 7, goal: 0.000101325, label: "1 atm", aiPredictions: [{ name: "Claude 4.6 Sonnet", year: 2071 }, { name: "Gemini 3.1 Pro Preview", year: 2077 }, { name: "GPT-5.4 Thinking Mini", year: 2095 }] },
              ],
              history: [

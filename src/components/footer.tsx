  ...
  return (
    <footer className="site-footer">
      <div className="site-footer__grid">
        ...
        <div><h2>Explore</h2><Link href="/">Progress</Link><Link href="/predictions">Predictions</Link><Link href="/retired-metrics">Retired metrics</Link><a href="https://ultimate-bench.vercel.app/" target="_blank" rel="noopener noreferrer">Ultimate Bench <span aria-hidden="true">↗</span></a></div>
